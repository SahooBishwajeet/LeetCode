...
/*
=> Using set to deal with repeating strings and palindromic strings (e.g. "zz")

=> Creating an Unordered_Set to store the reversed string.
=> In iteration, find the string in the set if reversed strings. If match => Result++
*/
